        ...
        <div className="container w-[90%] m-auto">
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-8">
            ...
            <div className="lg:w-4/12 hidden lg:block">
              <div className="mb-6">
                <Image src={haythamImage} alt="Haytham" className="w-full h-auto shadow-md" placeholder="blur" />
              </div>
        ...
        <div className="container w-[90%] m-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-15">
            <div className="text-center">
              <Image className="w-20 sm:w-28 md:w-36 mx-auto" src={icon1} alt="Remplissez le formulaire" />
            ...
            <div className="text-center">
              <Image className="w-20 sm:w-28 md:w-36 mx-auto" src={icon2} alt="Recevez l’appel d’un agent" />
              <h3 className="text-[#010E26] text-sm sm:text-xl mt-5 mb-2 font-bold uppercase" style={{ fontFamily: 'Jost' }}>
            ...
            <div className="text-center">
              <Image className="w-20 sm:w-28 md:w-36 mx-auto" src={icon3} alt="Confirmez Votre devis" />
              <h3 className="text-[#010E26] text-sm sm:text-xl mt-5 mb-2 font-bold uppercase" style={{ fontFamily: 'Jost' }}>
