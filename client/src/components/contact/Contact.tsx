                ...
                <div className="container w-[90%] m-auto">
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-8">
                                                    ...
                                                    {["BRANDING", "développement de sites Web", "Création de contenu", "Étude de marche", "AUTRES"].map(
                                                        (item) => (
                                                            <label key={item} className="relative">
                                                                ...
                                                                />
                                                                <span className={`inline-block border border-white text-[#f2f2f2] px-4 py-1 text-sm transition-all duration-200 cursor-pointer ${formData.interests.includes(item) ? 'bg-[#445EF2] text-white border-[#445EF2]' : 'hover:bg-white/10'
                                                                    }`}>
                                                                    {item}
                                                                </span>
                                                            </label>
                        ...
                        <div className="lg:w-4/12 text-[#f2f2f2] hidden lg:block">
                            <div className="mb-6 relative w-full h-[500px]">
                                <Image
                                    src={haythamImage}
                                    alt="Haytham"
                                    fill
