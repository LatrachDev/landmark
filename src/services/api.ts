...
export const api = {
	...
	team: {
		...
		create: (formData: FormData) =>
			fetch("/api/admin/team", { method: "POST", body: formData }).then(
				handleResponse,
			),
		update: (id: string, formData: FormData) =>
			fetch(`/api/admin/team/${id}`, { method: "PUT", body: formData }).then(
				handleResponse,
			),
		delete: (id: string) =>
	...
	projects: {
		...
		create: (formData: FormData) =>
			fetch("/api/admin/projects", { method: "POST", body: formData }).then(
				handleResponse,
			),
		update: (id: string, formData: FormData) =>
		...
		delete: (id: string) =>
			fetch(`/api/admin/projects/${id}`, { method: "DELETE" }).then(
				handleResponse,
			),
	},
	...
	content: {
		...
		create: (formData: FormData) =>
			fetch("/api/admin/content", { method: "POST", body: formData }).then(
				handleResponse,
			),
		update: (id: number, formData: FormData) =>
			fetch(`/api/admin/content/${id}`, { method: "PUT", body: formData }).then(
				handleResponse,
			),
		delete: (id: number) =>
			fetch(`/api/admin/content/${id}`, { method: "DELETE" }).then(
				handleResponse,
			),
	},
	...
	services: {
		...
		create: (formData: FormData) =>
			fetch("/api/admin/services", { method: "POST", body: formData }).then(
				handleResponse,
			),
		update: (id: string, formData: FormData) =>
