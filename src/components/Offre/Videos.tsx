...
const Videos = memo(function Videos(): JSX.Element {
    ...
    const videos = useMemo<VideoItem[]>(() => [
        { id: 1, src: Reel1, thumbnail: Thumbnail1, title: 'COSMARK', views: '501k' },
        { id: 2, src: Reel2, thumbnail: Thumbnail2, title: 'IKARM | YouCode', views: '150k' },
        { id: 3, src: Reel3, thumbnail: Thumbnail3, title: 'brimo chicken', views: '380k' },
        { id: 4, src: Reel4, thumbnail: Thumbnail4, title: 'DAR TURKIA', views: '231.6k' },
        { id: 5, src: Reel5, thumbnail: Thumbnail5, title: 'YASSIN GLOW', views: '220k' },
        { id: 6, src: Reel6, thumbnail: Thumbnail6, title: 'Nature Products', views: '120k' },
    ], []);
    ...
    const handleVideoClick = useCallback((videoId: number, index: number): void => {
    ...
    const handleVideoPause = useCallback((videoId: number): void => {
                ...
                <div className="relative">
                    ...
                    >
                        {videos.map((video, index) => (
                            <SwiperSlide key={video.id} className="flex flex-col items-center">
                                <div
                                ...
                                <div className="flex flex-col mt-4 sm:mt-0">
                                    <p className="text-white text-xs sm:text-sm md:text-base uppercase font-semibold mb-2 text-center" style={{ fontFamily: 'Jost' }}>
                                        {video.title}
                                    </p>
                                    <p className="text-cyan-400 text-lg sm:text-xl md:text-2xl font-bold text-center" style={{ fontFamily: 'Jost' }}>
                                        {video.views} views
                                    </p>
                                </div>
                            </SwiperSlide>
