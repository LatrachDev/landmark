		...
		<div className="bg-[#FFC300] font-[Jost] sticky py-4 px-4 sm:px-8 lg:px-20 z-50 text-white w-full flex flex-col md:flex-row items-center animate-slide-down">
			<div className="flex-1 flex flex-col md:flex-row items-start md:items-center justify-between gap-2 w-full">
				...
				<div className="flex items-center gap-2 w-full md:w-auto">
					...
					<Link
						href={"/offre"}
						className="bg-[#000000] py-2 flex-1 md:flex-none text-center font-bold hover:scale-105 duration-300 text-[#F2F2F2] px-3 md:px-4 cursor-pointer text-[12px] md:text-[16px] transition-colors inline-flex justify-center items-center gap-2 whitespace-nowrap"
					>
						<Image
							src="/icones/offre.png"
							alt="offre"
							width={20}
							height={20}
							className="shrink-0"
						/>
						Économisez
						<span className="hidden min-[390px]:inline">&nbsp;Maintenant</span>
					</Link>
				</div>
			</div>
		</div>
