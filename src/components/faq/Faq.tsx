...
const faqData = [
	{
		...
		content: "Une Voie Claire & Ciblée Pour Lancer Votre Entreprise.",
		items: [
	...
	{
		title: "BRAND DESIGN",
		content: "Créer & lancer une marque durable sur le marché.",
		items: [
			"Brand Design",
				...
				<div className="space-y-4 font-jost">
					{faqData.map((faq, index) => (
						<div key={index} className="border-b border-gray-300 pb-4">
							...
							>
								<div className="pl-4">
									<p className="text-sm sm:text-xl mb-4 text-gray-700">
										{faq.content}
									</p>
