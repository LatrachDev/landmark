					...
					<div className="flex flex-col-reverse lg:flex-row gap-8">
						...
						<div className="w-full lg:w-8/12">
							{!showSuccess ? (
								<div className="transition-all duration-500 ease-in-out">
									<h2 className="text-xl font-bold text-left text-[#f2f2f2] uppercase mb-4">
												...
												<div className="flex flex-wrap gap-2 uppercase mb-4">
													{[
														...
														<label key={item} className="relative">
															...
															/>
															<span
																className={`inline-block border border-white px-4 py-1 text-sm transition-all duration-200 ${
																	formData.interests.includes(item)
																		? "bg-[#445EF2] text-white"
																		: "hover:bg-gray-100 hover:text-[#010E26]"
																}`}
															>
																{item}
															</span>
								...
								<div className="lg:w-7/12 animate-fade-in">
									<div className="text-center py-12">
										...
										<h2 className="text-3xl font-bold text-[#f2f2f2] uppercase mb-4 animate-slide-up">
											Message Envoyé !
										</h2>
						...
						<div className="lg:w-4/12 hidden lg:block">
							<div className="mb-6">
								<Image
									src={haythamImage}
									alt="Haytham Guemmah - Fondateur Landmark Agency"
									className="w-full h-auto shadow-md"
									placeholder="blur"
								/>
							</div>
							<p className="italic text-justify text-xl mb-4">
								Saviez-vous que 4 clients sur 5 changent de marque à cause
								d&apos;une mauvaise expérience ou d&apos;un design médiocre ?{" "}
								<br />
							...
							<h3 className="font-bold text-xl uppercase">HAYTHAM GUERMAH</h3>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-15">
						<div className="text-center">
							<Image
								...
								src={icon1}
								alt="Étape 1 — Remplissez le formulaire"
							/>
							<h3
						...
						<div className="text-center">
							<Image
								className="w-20 sm:w-28 md:w-36 mx-auto"
								src={icon2}
								alt="Étape 2 — Recevez l'appel d'un agent"
							/>
							<h3
								className="text-[#010E26] text-sm sm:text-xl mt-5 mb-2 font-bold uppercase"
								style={{ fontFamily: "Jost" }}
						...
						<div className="text-center">
							<Image
								className="w-20 sm:w-28 md:w-36 mx-auto"
								src={icon3}
								alt="Étape 3 — Confirmez votre devis"
							/>
							<h3
								className="text-[#010E26] text-sm sm:text-xl mt-5 mb-2 font-bold uppercase"
								style={{ fontFamily: "Jost" }}
