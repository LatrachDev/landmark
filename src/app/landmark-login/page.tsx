		...
		<div className="h-screen w-screen flex overflow-hidden font-[Jost]">
			...
			>
				<div className="w-full max-w-md">
					...
					<div className="mb-10">
						<h1 className="text-3xl font-black text-[#010E26] uppercase tracking-tight mb-3">
							Administration
						</h1>
						<p className="text-gray-500 text-sm font-medium uppercase tracking-[0.15em]">
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						<div className="space-y-2">
							<label className="block text-[#010E26] text-xs font-bold uppercase tracking-wider ml-1">
								Email
							</label>
							<input
								type="email"
