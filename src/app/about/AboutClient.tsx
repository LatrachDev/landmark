		...
		<div className="font-['Jost'] relative min-h-screen">
			...
			<section className="text-left py-16 px-4 sm:px-10 w-[90%] m-auto relative z-10">
				<h1 className="sm:mt-24 mt-5 text-[#010e26] text-xl sm:text-2xl md:text-4xl font-bold uppercase tracking-wide mb-4 md:mb-6">
					Landmark est plus qu'une agence de marketing digital, c'est un espace
					où la créativité et la performance se rejoignent pour donner vie à des
					marques fortes.
				</h1>
				...
				<div className="py-16">
					<h2
						className="text-xl sm:text-2xl font-bold tracking-[0.2em] mb-6 uppercase pl-0 text-[#263973]"
					...
					<p className="mb-6 leading-relaxed text-[#666666]">
						<strong className="font-semibold text-[#666666]">
							Landmark est une agence de marketing digital basée à Oujda, au
							Maroc, qui aide les marques à se faire remarquer et à se
							développer.
						</strong>{" "}
						Nous créons des identités visuelles fortes, des contenus percutants
						et des stratégies de communication sur mesure pour attirer le bon
						public et augmenter l'engagement.
					</p>

					<p className="mb-6 leading-relaxed text-[#666666]">
						<strong className="font-semibold text-[#666666]">
							Notre objectif est simple : transformer des idées en marques
							mémorables et efficaces.
						</strong>{" "}
						Grâce à notre vision claire et notre capacité d'adaptation, nous
						accompagnons nos clients dans un monde en constante évolution. Que
						vous lanciez votre projet ou que vous souhaitiez améliorer votre
						présence en ligne, nous sommes là pour vous guider à chaque étape.
					</p>
					...
					<p className="leading-relaxed text-[#666666]">
						<strong className="font-semibold text-[#666666]">
							Ce qui fait notre différence ? Une vraie écoute, une équipe
							créative, et une approche sur mesure.
						</strong>{" "}
						Que vous soyez une petite entreprise locale ou une marque
						ambitieuse, Landmark est là pour vous aider à grandir.
					</p>

					<h2
						className="text-xl mt-20 sm:text-2xl font-bold tracking-[0.2em] mb-6 uppercase pl-0 text-[#263973]"
						style={{ fontFamily: "bodoni" }}
					>
						Équipe Landmark
					</h2>
					...
					<section className="flex flex-wrap gap-8 md:gap-6 justify-center pt-5">
                        ...
                        <p className="text-white text-center text-sm font-light uppercase tracking-wide">
                          {name}
									...
									{/* Team Member Info */}
									<div className="mt-6">
										<p className="text-[#010e26] uppercase mb-2 font-bold text-base">
											{name}
										</p>
