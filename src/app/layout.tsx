...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		title:
			"Landmark - Agence Marketing Digital au Maroc | Branding & Stratégie Créative",
		description:
			"Renforcez votre présence en ligne, créez une identité de marque forte et captivez votre audience avec Landmark - top agence de marketing digital au Maroc",
		images: [
			{
