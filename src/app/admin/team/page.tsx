			...
			<div className="max-w-7xl mx-auto px-6 lg:px-10 py-12">
				...
				<AnimatePresence mode="wait">
					{(showCreateForm || showUpdateForm) && (
						...
						>
							<div
								className={`p-8 md:p-10 rounded-[2.5rem] border ${showUpdateForm ? "bg-blue-50/50 border-blue-100" : "bg-gray-50/50 border-gray-100"}`}
							>
								<h2 className="text-2xl font-black text-[#010E26] uppercase mb-8">
									{showCreateForm
										? "Ajouter un nouveau membre"
										: `Modifier : ${memberToEdit?.name}`}
								</h2>
				...
				{isLoading ? (
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{teamMembers.map((member) => (
							...
							>
								<div className="relative aspect-square w-full rounded-4xl overflow-hidden mb-6 bg-gray-100">
									<img
										src={member.imageUrl}
										alt={member.name}
								...
								<div className="grow">
									...
									<h3 className="text-xl font-bold text-[#010E26] uppercase mb-3">
										{member.name}
									</h3>
								...
								<div className="flex gap-4 pt-6 border-t border-gray-50">
									{member.linkedin && (
										<a
											...
											className="text-gray-400 hover:text-[#445EF2] transition-colors"
