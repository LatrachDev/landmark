				...
				<div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
					<div>
						...
						<p className="text-gray-500 font-medium">
							Ajoutez, modifiez ou supprimez les services que Landmark propose à
							ses clients.
						</p>
					</div>
					<button
										...
										{serviceToEdit && showUpdateForm && !formData.image && (
											<div className="mb-3">
												...
												<img
													...
													className="h-16 w-24 object-cover rounded-xl border border-gray-100"
													alt="current"
												/>
											</div>
										)}
				...
				{isLoading ? (
					...
					<div className="py-20 text-center">
						<p className="text-gray-300 font-black uppercase tracking-[0.3em] text-[10px]">
							Aucun service actuellement listé
						</p>
					</div>
				) : (
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{services.map((s) => (
							...
							>
								<div className="relative aspect-[4/3] w-full rounded-4xl overflow-hidden mb-6 bg-gray-100">
									<img
										src={s.imageUrl}
										alt={s.title}
								...
								<div className="grow">
									<span
										className={`font-black uppercase text-[10px] tracking-[0.2em] mb-3 inline-block px-3 py-1 rounded-lg ${CATEGORY_BADGE[s.category]}`}
									>
